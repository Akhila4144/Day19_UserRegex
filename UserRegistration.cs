...
namespace Day19_UserRegistration
{
    class UserRegistration
    {
        ...
        public static string Regex_PhoneNumber = "^[+][9][1][6-9]{1}[0-9]{9}$";
        public static string Regex_Password = "^[A_Z}{6}[@]{3}[0-9]{2}$";
        ...
        public static void CheckPassword(string Password)
        {
            ...
            {
                Console.WriteLine(" password is invalid  enter minimum 6  Upper case 3 SpecialCase and 2 numbers ");
